...
class Map extends Component {
  ...
  map = {
    ...
    areas: [
      ...
      { alt: '2', shape: 'poly', preFillColor: this.props.need[1], fillColor: 'rgba(150, 138, 0, 0.2)', coords: [467,153,472,163,486,199,448,205,456,276,436,258,397,272,367,290,372,310,344,314,309,293,292,299,291,277,265,278,263,271,166,273,163,282,132,281,133,264,161,255,210,138,269,168,357,163,413,160,332,158,286,169] },
      ...
      { alt: '5', shape: 'poly', preFillColor: this.props.need[4], fillColor: 'rgba(150, 138, 0, 0.2)', coords: [456,279,464,341,435,363,360,365,351,380,343,383,334,426,305,428,301,400,215,411,223,390,281,385,320,341,377,317,374,290,429,264] },
      ...
      { alt: '7', shape: 'poly', preFillColor: this.props.need[6], fillColor: 'rgba(150, 138, 0, 0.2)', coords: [59,562,81,717,238,723,251,701,223,696,217,644,305,641,329,648,349,608,390,590,361,585,360,550,315,511,333,494,343,454,332,431,302,429,298,408,281,408,276,422,255,422,253,416,216,416,203,426,208,570,111,575,85,562] },
      ...
      { alt: '12', shape: 'poly', preFillColor: this.props.need[10], fillColor: 'rgba(150, 138, 0, 0.2)', coords: [289,348,42,371,44,403,211,395,277,378] },
    ]
  }
  render() {
    return (
